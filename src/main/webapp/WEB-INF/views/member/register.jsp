          ...
          <div class="row align-items-center justify-content-center">
            <div class="col-md-6 col-sm-8 mt-3">
              ...
              <div class="position-relative">
                <div>
                  <form name="registerForm" class="needs-validation" novalidate action="register-action" method="post">
                    ...
                    <div class="input-icon-group mb-3">
                      ...
                      <input type="text" class="form-control" required id="uname" name="name" autofocus placeholder="이름" value="${errors.name}" style="${not empty errors.name ? 'color:red' : ''}">
                    </div>
                    ...
                    <div class="input-icon-group mb-3">
                      ...
                      <input type="email" class="form-control" required id="email" name="email" placeholder="이메일" value="${errors.email}" style="${not empty errors.email ? 'color:red' : ''}">
                    </div>
